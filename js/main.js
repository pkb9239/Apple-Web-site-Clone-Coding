(() => {
    ...
    function calcValues(values, currentYOffset) {  //currentYOffset은 현재 씬에서 얼마나 스크롤 됐는지
        let rv;
        ...
        switch (currentScene) {
            ...
            case 2:
                ...
                if (scrollRatio > 0.9) {
                    ...
                    // window.innerWidth이랑 document.body.offsetWidth랑 다름 document.body.offsetWidth는 스크롤커서 공간 포함 x
